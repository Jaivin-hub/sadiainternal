...
module.exports = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      template: 'src/layouts/recipe-category-listing.hbs',  // Template for recipe listing page
      inject: true,
      filename: 'recipe-category-listing.html',
    }),
    new HtmlWebpackPlugin({
      template: 'src/layouts/cooking-hacks-details.hbs',  // Template for recipe listing page
      inject: true,
      filename: 'cooking-hacks-details.html',
    }),
    new HtmlWebpackPlugin({
      template: 'src/layouts/contact.hbs',  // Template for recipe listing page
      inject: true,
    ...
    new HtmlWebpackPlugin({
      template: 'src/layouts/404.hbs',  // Template for recipe listing page
      inject: true,
      filename: '404.html',
    }),
    new HtmlWebpackPlugin({
      template: 'src/layouts/thankyou.hbs',  // Template for recipe listing page
      inject: true,
